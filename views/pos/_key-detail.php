...
//            ' (Check: <b>' . KeyCheck::KCV($key->Comp2) . '</b>)',
        ...
        [
            ...
            ' (Check: <b>' . $key->Comp3Check . '</b>)',
//            ' (Check: <b>' . KeyCheck::KCV($key->Comp3) . '</b>)',
        ],
        [
            'attribute' => 'FullKey',
            'valueColOptions' => ['style' => 'font-family: monospace; font-size: 14px; color: blue; '],
            'format' => 'raw',
            'value' => '<b>' . Convert::KeyByGroup($key->FullKey) . '</b>',
        ],
    ],
]);
